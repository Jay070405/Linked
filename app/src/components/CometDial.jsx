// React Bits / David Haz — https://reactbits.dev/micro/comet-dial
// License: REACT-BITS-LICENSE.md. Local changes: SVG viewBox, reduced override.
